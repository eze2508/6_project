...
const int duty_cycle_step = 5; // Tamaño del paso para cambios suaves en el ciclo de trabajo
...
void calculate_speed() {
    if (pulse_count >= PULSES_PER_REV) {
        ...
        sleep_ms(1000);  // Pausa de 500 ms para hacer más legible la salida
    }
}
...
int main() {
    ...
    // Inicializar el pin del botón para el control de crucero
